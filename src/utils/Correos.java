...
//	Enviar correo sin adjunto
	public void enviarConfirmacion(String destinatario, String ficha, String codEquipo, String nombre) {
		try
        {
            ...
            message.setText(            		
            		...
            		"	<div style=\"font-size:12px;line-height:14px;font-family:TimesNewRoman, 'Times New Roman', Times, Baskerville, Georgia, serif;color:#555555;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: right\"><br></p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"                    <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\"><![endif]-->\r\n" + 
            		"<div style=\"color:#555555;line-height:120%;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\">	\r\n" + 
            		"	<div style=\"font-size:12px;line-height:14px;color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px\"><strong>N° FICHA: "+ficha+"</strong> <br></p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"              </div>\r\n" + 
            		"            </div>\r\n" + 
            		"              <!--[if (mso)|(IE)]></td><td align=\"center\" width=\"310\" style=\" width:310px; padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:5px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;\" valign=\"top\"><![endif]-->\r\n" + 
            		"            <div class=\"col num6\" style=\"max-width: 320px;min-width: 310px;display: table-cell;vertical-align: top;\">\r\n" + 
            		"              <div style=\"background-color: transparent; width: 100% !important;\">\r\n" + 
            		"              <!--[if (!mso)&(!IE)]><!--><div style=\"border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;\"><!--<![endif]-->\r\n" + 
            		"\r\n" + 
            		...
            		"                    <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\"><![endif]-->\r\n" + 
            		"<div style=\"color:#555555;line-height:120%;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\">	\r\n" + 
            		"	<div style=\"font-size:12px;line-height:14px;color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px\"><strong>COD. EQUIPO: "+codEquipo+"</strong><br></p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"  <img class=\"center fixedwidth\" align=\"center\" border=\"0\" src=\"https://pro-bee-template-catalog-public.s3.amazonaws.com/templates/default/18/okok.gif\" alt=\"Image\" title=\"Image\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 155px\" width=\"155\">\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"</div>\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"<div style=\"font-size:12px;line-height:14px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;color:#71777D;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\">Hola "+nombre+"; te informamos que tu equipo ha sido preinscrito.<br></p><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\">Dispones de 48 Horas para realizar el pago y culminar tu proceso de inscripción.<br data-mce-bogus=\"1\"></p><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\">&#160;<br></p><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\">Agradecemos tu participación.</p><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\">&#160;<br></p><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\">El equipo de EVENTOS DEPORTIVOS.</p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
	...
	public void enviarBoleta(String destinatario, ConstanciaDTO dato, String monto, String nombre) {
		try
        {
            // Propiedades de la conexión
            Properties props = new Properties();
            ...
            message.addRecipient(
                Message.RecipientType.TO,// a quien va el correo
                new InternetAddress(destinatario));
            message.setSubject("CONFIRMACION DE PAGO E INSCRIPCION");
            message.setText(
            		"<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\"><head>\r\n" + 
            		"    <!--[if gte mso 9]><xml>\r\n" + 
            		"     <o:OfficeDocumentSettings>\r\n" + 
            		...
            		"                    <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\"><![endif]-->\r\n" + 
            		"<div style=\"color:#555555;line-height:120%;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\">	\r\n" + 
            		"	<div style=\"font-size:12px;line-height:14px;color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px\"><strong>N° FICHA: "+dato.getCod_ficha()+"</strong> <br></p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"                    <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\"><![endif]-->\r\n" + 
            		"<div style=\"color:#555555;line-height:120%;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\">	\r\n" + 
            		"	<div style=\"font-size:12px;line-height:14px;color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px\"><strong>COD. EQUIPO: "+dato.getCod_equipo()+"</strong><br></p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"                    <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 5px;\"><![endif]-->\r\n" + 
            		"<div style=\"font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;color:#000000; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 5px;\">	\r\n" + 
            		"	<div style=\"font-size:12px;line-height:14px;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;color:#000000;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: center\"><strong><span style=\"font-size: 18px; line-height: 21px;\">Gracias por participar</span></strong><strong><span style=\"font-size: 18px; line-height: 21px;\">!</span></strong></p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"                    <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 25px;\"><![endif]-->\r\n" + 
            		"<div style=\"font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;color:#71777D; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 25px;\">	\r\n" + 
            		"	<div style=\"font-size:12px;line-height:14px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;color:#71777D;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\">Hola "+nombre+"; te informamos que tu equipo "+dato.getNom_equipo()+" ha sido registrado con exito en el evento <br></p><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\">"+dato.getDesc_evento()+" para la modalidad "+dato.getDesc_modalidad()+" que iniciará el dia "+dato.getFec_inicio()+".<br data-mce-bogus=\"1\"></p><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\"><br data-mce-bogus=\"1\"></p><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\">Agradecemos tu participación.<br data-mce-bogus=\"1\"></p><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\"><br data-mce-bogus=\"1\"></p><p style=\"margin: 0;font-size: 14px;line-height: 17px;text-align: left\">El equipo de EVENTOS DEPORTIVOS.<br data-mce-bogus=\"1\"></p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"	<div style=\"font-size:12px;line-height:14px;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;color:#FFFFFF;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px\">CARGO</p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"                    <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 20px; padding-left: 20px; padding-top: 10px; padding-bottom: 10px;\"><![endif]-->\r\n" + 
            		"<div style=\"font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;color:#FFFFFF; padding-right: 20px; padding-left: 20px; padding-top: 10px; padding-bottom: 10px;\">	\r\n" + 
            		"	<div style=\"font-size:12px;line-height:14px;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;color:#FFFFFF;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px\">MONTO<br></p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"	<div style=\"font-size:12px;line-height:14px;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;color:#000000;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px\"><span style=\"color: rgb(0, 0, 0); font-size: 14px; line-height: 16px;\"><a style=\"color:#71777D;text-decoration: none; color: rgb(0, 0, 0);\" rel=\"noopener\">"+dato.getDesc_evento()+"</a></span><br data-mce-bogus=\"1\"></p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"                    <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 20px; padding-left: 20px; padding-top: 10px; padding-bottom: 10px;\"><![endif]-->\r\n" + 
            		"<div style=\"font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;color:#000000; padding-right: 20px; padding-left: 20px; padding-top: 10px; padding-bottom: 10px;\">	\r\n" + 
            		"	<div style=\"font-size:12px;line-height:14px;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;color:#000000;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px\"> S/. "+monto+"<br></p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
            		...
            		"                    <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding-right: 20px; padding-left: 20px; padding-top: 5px; padding-bottom: 5px;\"><![endif]-->\r\n" + 
            		"<div style=\"font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;color:#000000; padding-right: 20px; padding-left: 20px; padding-top: 5px; padding-bottom: 5px;\">	\r\n" + 
            		"	<div style=\"font-size:12px;line-height:14px;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;color:#000000;text-align:left;\"><p style=\"margin: 0;font-size: 14px;line-height: 17px\"><strong> S/. "+monto+"<br></strong></p></div>	\r\n" + 
            		"</div>\r\n" + 
            		"<!--[if mso]></td></tr></table><![endif]-->\r\n" + 
            		"\r\n" + 
            		"                  \r\n" + 
